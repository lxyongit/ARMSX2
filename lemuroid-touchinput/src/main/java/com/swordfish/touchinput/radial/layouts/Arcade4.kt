...
import com.swordfish.touchinput.radial.ui.LemuroidCentralButtonOne
import com.swordfish.touchinput.radial.ui.KeyMode
            ...
            LemuroidControlFaceButtons(
                ...
                idsForegrounds =
                    persistentMapOf<Id.Key, @Composable (State<Boolean>) -> Unit>(
                        ...
                        Id.Key(KeyEvent.KEYCODE_BUTTON_Y) to { LemuroidButtonForeground(pressed = it, label = "X") },
                        Id.Key(KeyEvent.KEYCODE_BUTTON_X) to { LemuroidButtonForeground(pressed = it, label = "Y") },
                    ),
            )
        },
        secondaryDials = {
...
@Composable
fun SecondaryButtonABX(modifier: Modifier = Modifier.radialPosition(90f)) {
    ControlButton(
        modifier = modifier,
        id = Id.Key(KeyEvent.KEYCODE_UNKNOWN),
        background = {},
        foreground = { pressed ->
            LemuroidCentralButtonOne(
