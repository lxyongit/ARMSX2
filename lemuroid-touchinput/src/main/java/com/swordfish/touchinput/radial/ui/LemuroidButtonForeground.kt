...
private fun BoxWithConstraintsScope.LemuroidButtonForegroundLabel(
    ...
    val longestLineLength = lines.maxOfOrNull { it.length } ?: label.length
    val fontSize = minOf(maxHeight * 0.5f * scale, maxWidth / longestLineLength * scale)
    Text(
